   ...
   const sliderData = [
      {
         ...
         img: 'assets/img/slider/topshot.jpg',
      }
   ]
   return (
      <>
               ...
               >

                  {
                     sliderData.map(slider => {
                        return <div key={slider.id} className="slider__item swiper-slide p-relative slider__height d-flex align-items-center z-index-1">
                              ...
                              <div className="row">
                                 ...
                                 <div className="col-xxl-7 col-xl-8 col-lg-8 col-md-10 col-sm-10">
                                    <div className="slider__content p-relative z-index-1">
                                       <span style={{color:"#74ACAC"}}>Serving the Temple Area</span>
                                       <h2 className="slider__title" >{slider.title}</h2>
                                       <p>We believe everyone deserves a clean home.</p>
