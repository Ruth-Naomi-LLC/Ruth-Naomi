              ...
              <div className="contact__wrapper">
                <div className="section__title-wrapper mb-40">
                  <h2 className="section__title">
                    Get in
                    <span className="yellow-bg yellow-bg-big"> touch</span>
                  </h2>
                  <p>
                    Write a description of the services you are requesting and we will call or write you back with an estimate!
                  </p>
                </div>
                        ...
                        <div className="contact__info-text">
                          ...
                          <p>
                            <a
                              target="_blank"
                              rel="noreferrer"
                              href="https://www.google.com/maps/place/Ruth+%26+Naomi+Co.+LLC+Housekeeping%2FMaid+Service+ETC/@31.1228957,-97.4265475,17z/data=!3m1!4b1!4m6!3m5!1s0x86456b5bff0757eb:0x90561d638fa827ff!8m2!3d31.1228911!4d-97.4239726!16s%2Fg%2F11kmny8lbm?entry=ttu"
                            >
                              7804 Bridgepointe Drive, Temple, TX, United
                              States, Texas
                            </a>
                          </p>
                        </div>
                    ...
                    <li>
                      <div className="contact__info-item d-flex align-items-start mb-35">
                        ...
                        <div className="contact__info-text">
                          ...
                          <p>
                            <a href="mailto:management@ruthandnaomico.com">
                              management@ruthandnaomico.com
                            </a>
                          </p>
                          <p>
                            <a href="mailto:info@educal.com"> </a>
                          </p>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div className="contact__info-item d-flex align-items-start mb-35">
                        ...
                        <div className="contact__info-text">
                          <h4>Phone</h4>
                          <p>
                            <a href="tel:1-800-555-555">1-254-598-6048</a>
                          </p>
                        </div>
                      </div>
                    </li>
